...
@section('title', 'Tambah Kelas Lomba')

@section('page-title', 'Tambah Kelas Lomba')
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Form Tambah Kelas Lomba</h3>
        </div>
        <form action="{{ route('kelas-lomba.store') }}" method="POST">
            @csrf
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nomor_kelas') is-invalid @enderror" 
                           ...
                           value="{{ old('nomor_kelas') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="1" 
                           ...
                           value="{{ old('batas_peserta') }}">
                    <small class="form-text text-muted">Masukkan jumlah maksimal peserta untuk kelas ini. Kosongkan jika tidak ada batas.</small>
                    @error('batas_peserta')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
